require "test_helper"
require "generators/hdi/ways_of_working/code_of_conduct/code_of_conduct_generator"

class Hdi::WaysOfWorking::CodeOfConductGeneratorTest < Rails::Generators::TestCase
  tests Hdi::WaysOfWorking::CodeOfConductGenerator
