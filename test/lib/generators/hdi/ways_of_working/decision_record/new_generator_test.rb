require "test_helper"
require "generators/hdi/ways_of_working/decision_record/new/new_generator"

class Hdi::WaysOfWorking::DecisionRecord::NewGeneratorTest < Rails::Generators::TestCase
  tests Hdi::WaysOfWorking::DecisionRecord::NewGenerator
